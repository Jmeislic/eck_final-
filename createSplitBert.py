...
MODEL_OUTPUT_DIR = "./conditional_decomposition_bart_model"
TRAINING_DATASET = "cleaned_data.csv"

# **PLACEHOLDERS:** Replace these with your actual column names in a non-sensitive context.
INPUT_COLUMN = "explanation"
STATIC_OUTPUT_COLUMNS = [ "norm", "situation", "intention"] # Equivalent to norm, situation, intention
...
if __name__ == '__main__':
    ...
    while True:
        test_sentence = input("Ask bebs model: ")
